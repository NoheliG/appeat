         ...
         <div data-role="page">
           ...
           <div data-role="main" class="ui-content" style="margin-top: 70px; color:white" >
                ...
                <form class="form" style="" action="#" method="post">
                    ...
                    <input   type="text" id="nombre_restaurante" name="nombre_restaurante" required="required" />
                    <label id="texto" >N° RUC</label>
                    <input  type="number" id="ruc" name="ruc"  maxlength="11" required="required" />
                    <label id="texto" >Telefono</label>
                    <input  type="number" id="telefono" name="telefono"  maxlength="9" required="required" />
                    <label id="texto">Correo</label>
                    <input  type="text"   id="correo_restaurante" name="correo_restaurante" required="required" />
                    <label id="texto">Usuario</label>
                    <input  type="text" id="nombre_usuario2" name="nombre_usuario" required="required" />
                    <label id="texto" >Contrase&ntilde;a</label>
                    <input  type="password" id="clave2" name="clave" required="required" />
